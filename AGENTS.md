...
4. Push your feature branch: `git push origin <branch-name>` — open a PR if one doesn't exist yet
...
- Amber accents for primary actions, teal for completed steps, coral for attention items, utility companies highlighted in brand colors
...
- Test Docker builds locally before deploying: `docker build -t venture-solar-crm-timeline . && docker run -p 8080:8080 venture-solar-crm-timeline`
...
claude --add-dir .
# Paste: "You are the Frontend Agent for venture-solar-crm-timeline. [Track B brief here]"

# Terminal 2 — start data-integration agent
claude --add-dir .
# Paste: "You are the Data Integration Agent for venture-solar-crm-timeline. [Track A brief here]"
```
